...
class RegistrationFormType extends AbstractType implements ContainerAwareInterface {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options){
        ...
        $managerName = $container->get('app.connection_service')->getManagerName();
        ...
        $builder->add('description', 'textarea', array('label' => 'form.nameIndicatorTactic', 'label_attr' => array('class' => 'label'), 'translation_domain' => 'PequivenIndicatorBundle','attr' => array('cols' => 50, 'rows' => 5,'class' => 'input validate[required]')));
        ...
        //Peso del Indicador
        $builder->add('weight','percent',array('label' => 'form.weightIndicatorTactic','label_attr' => array('class' => 'label'), 'translation_domain' => 'PequivenIndicatorBundle','attr' => array( 'class' => 'input validate[required]', 'size' => 8)));
        //Meta del Objetivo
        //$builder->add('goal','percent',array('label' => 'form.goalIndicatorTactic','label_attr' => array('class' => 'label'), 'translation_domain' => 'PequivenIndicatorBundle','attr' => array('class' => 'input validate[required]', 'size' => 8)));
        //Fórmula del indicador a crear
        $builder->addEventSubscriber(new AddFormulaFieldListener($this->container,array('typeTactic' => true)));
        ...
        //Rango de Gestión
            ...
            $builder->add('tendency','entity',array('label' => 'form.conduct','data' => $dataTendency,'label_attr' => array('class' => 'label'), 'translation_domain' => 'PequivenIndicatorBundle', 'expanded' => true, 'multiple' => false, 'property' => 'description','class' => 'PequivenMasterBundle:Tendency','empty_value' => false, 'required' => false, 'em' => $managerName));
            ...
            //Rango Alto Básico
                ...
                $builder->add('opRankTopBasic','entity',array('label_attr' => array('class' => 'label'),'attr' => array('style' => 'border-radius:6px;'),'property' => 'ref','class' => 'PequivenMasterBundle:Operator','empty_value' => '', 'required' => false,'mapped' => false,'data' => $operatorHigherEqualThan, 'em' => $managerName));
            //Rango Alto Mixto
                ...
                $builder->add('opRankTopMixedTop','entity',array('label_attr' => array('class' => 'label'),'property' => 'ref','class' => 'PequivenMasterBundle:Operator','empty_value' => '', 'required' => false,'mapped' => false, 'em' => $managerName));
                ...
                $builder->add('opRankTopMixedBottom','entity',array('label_attr' => array('class' => 'label'),'property' => 'ref','class' => 'PequivenMasterBundle:Operator','empty_value' => '', 'required' => false,'mapped' => false, 'em' => $managerName));
            ...
            //Rango Medio Alto Básico
                ...
                $builder->add('opRankMiddleTopBasic','entity',array('label_attr' => array('class' => 'label'),'property' => 'ref','class' => 'PequivenMasterBundle:Operator','empty_value' => '', 'required' => false,'mapped' => false, 'data' => $operatorSmallerThan, 'em' => $managerName));
            //Rango Medio Alto Mixto
                ...
                $builder->add('opRankMiddleTopMixedTop','entity',array('label_attr' => array('class' => 'label'),'property' => 'ref','class' => 'PequivenMasterBundle:Operator','empty_value' => '', 'required' => false,'mapped' => false, 'em' => $managerName));
                ...
                $builder->add('opRankMiddleTopMixedBottom','entity',array('label_attr' => array('class' => 'label'),'property' => 'ref','class' => 'PequivenMasterBundle:Operator','empty_value' => '', 'required' => false,'mapped' => false, 'em' => $managerName));
            ...
            //Rango Medio Bajo Básico
                ...
                $builder->add('opRankMiddleBottomBasic','entity',array('label_attr' => array('class' => 'label'),'property' => 'ref','class' => 'PequivenMasterBundle:Operator','empty_value' => '', 'required' => false,'mapped' => false, 'data' => $operatorHigherEqualThan, 'em' => $managerName));
            //Rango Medio Bajo Mixto
                ...
                $builder->add('opRankMiddleBottomMixedTop','entity',array('label_attr' => array('class' => 'label'),'property' => 'ref','class' => 'PequivenMasterBundle:Operator','empty_value' => '', 'required' => false,'mapped' => false, 'em' => $managerName));
                ...
                $builder->add('opRankMiddleBottomMixedBottom','entity',array('label_attr' => array('class' => 'label'),'property' => 'ref','class' => 'PequivenMasterBundle:Operator','empty_value' => '', 'required' => false,'mapped' => false, 'em' => $managerName));
            ...
            $builder->add('arrangementRangeTypeBottom','entity',array('label' => 'form.arrangementRangeTypeBottom','label_attr' => array('class' => 'label'), 'translation_domain' => 'PequivenIndicatorBundle', 'expanded' => true, 'multiple' => false, 'property' => 'description','class' => 'PequivenMasterBundle:ArrangementRangeType','empty_value' => false, 'required' => false,'choices' => $selectRangeTypeBottom,'mapped' => false, 'em' => $managerName));
        ...
        //Comportamiento No Estable
            //Rango Bajo Básico
                ...
                $builder->add('opRankBottomBasic','entity',array('label_attr' => array('class' => 'label'),'property' => 'ref','class' => 'PequivenMasterBundle:Operator','empty_value' => '', 'required' => false,'mapped' => false, 'data' => $operatorSmallerThan, 'em' => $managerName));
            //Rango Bajo Mixto
                ...
                $builder->add('opRankBottomMixedTop','entity',array('label_attr' => array('class' => 'label'),'property' => 'ref','class' => 'PequivenMasterBundle:Operator','empty_value' => '', 'required' => false,'mapped' => false, 'em' => $managerName));
                ...
                $builder->add('opRankBottomMixedBottom','entity',array('label_attr' => array('class' => 'label'),'property' => 'ref','class' => 'PequivenMasterBundle:Operator','empty_value' => '', 'required' => false,'mapped' => false, 'em' => $managerName));
        //Comportamiento Estable
            //Rango Bajo Básico Alto
                ...
                $builder->add('opRankBottomTopBasic','entity',array('label_attr' => array('class' => 'label'),'property' => 'ref','class' => 'PequivenMasterBundle:Operator','empty_value' => '', 'required' => false,'mapped' => false, 'data' => $operatorHigherEqualThan, 'em' => $managerName));
            //Rango Bajo Básico Bajo
                ...
                $builder->add('opRankBottomBottomBasic','entity',array('label_attr' => array('class' => 'label'),'property' => 'ref','class' => 'PequivenMasterBundle:Operator','empty_value' => '', 'required' => false,'mapped' => false, 'data' => $operatorSmallerEqualThan, 'em' => $managerName));
    }
