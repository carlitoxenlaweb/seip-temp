...
class RegistrationFormType extends AbstractType implements ContainerAwareInterface {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder->add('description', 'textarea', array('label' => 'form.nameIndicatorStrategic', 'label_attr' => array('class' => 'label'), 'translation_domain' => 'PequivenIndicatorBundle', 'attr' => array('cols' => 50, 'rows' => 5, 'class' => 'input validate[required]')));
        ...
        $builder->add('tendency', 'entity', array('label' => 'form.conduct',
            'data' => $dataTendency,
            'label_attr' => array('class' => 'label'),
            'translation_domain' => 'PequivenIndicatorBundle',
            'expanded' => true,
            'multiple' => false,
            'property' => 'description',
            'class' => 'PequivenMasterBundle:Tendency',
            'empty_value' => false,
            'required' => false,
            'em' => $managerName)
        );
